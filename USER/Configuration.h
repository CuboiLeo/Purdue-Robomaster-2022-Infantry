...
//******************摇杆中位偏置************************
#define RC_Right_VRx_Offset 0
#define RC_Right_VRy_Offset 0
#define RC_Left_VRx_Offset 0
#define RC_Left_VRy_Offset 0


//***************云台电机配置声明********************
#define Yaw_Direction		 1			//电机安装方向，1或-1
#define Pitch_Direction	 1			//电机安装方向，1或-1
#define Pitch_Mid_encode 5800   //Pitch轴电机中点码值
#define Yaw_Mid_encode 5924      //Yaw轴电机中点码值
...
//******************新版本底盘速度参数配置*********************
#define Wz_MAX_init 			 7.5f		//5.0	// rad/s,弧度每秒 4.5   小陀螺旋转速度也与这个限幅有关   6.5 测试结果表明电容最低最低也能保证小陀螺一个速度
...
//*************拨弹电机*****************
#define PID_FIRE_SPEED_KP			(20.0f)  //3.5f
#define PID_FIRE_SPEED_KI			(0.01f)
#define PID_FIRE_SPEED_KD			(0)     //6.0f
#define PID_FIRE_SPEED_I_MAX	(1000)	//积分最大值
#define DEGREE_60_TO_ENCODER   37500 

//*************Friction Wheel Motor*****************
#define PID_FRIC_SPEED_KP			(10.0f)
#define PID_FRIC_SPEED_KI			(0.05f)
#define PID_FRIC_SPEED_KD			(0)
#define PID_FRIC_SPEED_I_MAX 	(1000)
#define PID_FRIC_SPEED_I_ERROR (100)
